<template>
  <div>
    <div style="position: absolute; top: 0; width: 100%">
      <v-toolbar dark class="px-sm-4 primary--text text-uppercase" style="background: transparent">
        ...
        <div class="mx-1">
          ...
          <v-menu v-else open-on-hover bottom offset-y origin="top center" transition="scale-transition">
            ...
            <v-list>
              <v-list-item link>
                <v-list-item-title @click="$router.push({ name: 'dashboard' })">{{ $t("dashboard") }}</v-list-item-title>
              </v-list-item>
              <v-divider></v-divider>
              <v-list-item link>
